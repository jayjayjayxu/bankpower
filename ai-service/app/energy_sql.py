...
ALLOWED_COLUMNS: dict[str, set[str]] = {
    ...
    "enterprise_energy_features": {
        ...
        "peak_ratio", "flat_ratio", "valley_ratio", "critical_peak_ratio", "peak_plus_critical_ratio", "avg_load_kw",
        "max_load_kw", "min_load_kw", "p50_load_kw", "p95_load_kw", "load_factor", "load_std_kw", "load_cv",
        "monthly_power_cv", "max_month_power_kwh", "min_month_power_kwh", "highest_power_month", "lowest_power_month",
        "daytime_power_ratio", "nighttime_power_ratio", "workday_power_ratio", "weekend_power_ratio", "annual_max_demand_kw",
        "demand_peak_ratio", "revenue_wanyuan", "electricity_revenue_ratio", "data_type", "feature_confidence", "created_at",
    },
    "enterprise_bank_observation": {
        "observation_id", "company_id", "observation_version", "as_of_date", "project_finance_potential", "green_finance_potential",
        "supply_chain_potential", "equipment_finance_potential", "working_capital_potential", "cash_management_potential",
        "bankability_score", "potential_bank_product", "marketing_notes", "scenario_basis", "source_id",
    },
    "enterprise_finance_opportunity_v1": {
        "opportunity_id", "company_id", "storage_run_id", "financing_run_id", "analysis_year", "opportunity_version",
        "storage_power_mw", "storage_capacity_mwh", "project_capex_wanyuan", "project_npv_wanyuan", "project_irr",
        "payback_years", "base_debt_ratio", "base_loan_amount_wanyuan", "base_min_dscr", "max_feasible_debt_ratio",
        "max_feasible_loan_wanyuan", "tariff_spread_risk", "capex_risk", "grid_capacity_risk", "degradation_risk",
        "overall_sensitivity_risk", "green_finance_status", "demand_response_status", "vpp_status", "engineering_status",
        "safety_status", "tariff_verification_status", "opportunity_level", "readiness_level", "risk_level",
        "potential_financing_amount_wanyuan", "opportunity_reason", "key_risk_notes", "next_action", "data_type", "created_at", "updated_at",
    },
    "enterprise_policy_assessment_v1": {
        "assessment_id", "assessment_key", "policy_rule_id", "company_id", "storage_run_id", "assessment_scope",
        "applicability_status", "evidence_status", "evidence_summary", "missing_evidence", "model_gate_status",
        "resulting_action", "assessment_confidence", "analyst_note", "assessed_at", "updated_at",
    },
